            ...
            return readFile(this._getAbsoPath(_constants2.default.PATH.CONF)).then(function (jsonStr) {
                ...
                Object.keys(json).forEach(function (apiName) {
                    ...
                    if (getInfo) {
                        ...
                        _this4.logger.info([_constants2.default.LOG.METHOD, method, _constants2.default.LOG.PARAM, JSON.stringify(getInfo, null, ' ')].join('\n'));
                    }
                    ...
                    if (postInfo) {
                        ...
                        _this4.logger.info([_constants2.default.LOG.METHOD, method, _constants2.default.LOG.PARAM, JSON.stringify(postInfo, null, ' ')].join('\n'));
                    }
                });
